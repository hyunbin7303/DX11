/*
FILE	   : timerTesting.cpp
PROGRAMMER : Kevin Park(Hyunbin Park)
Resource From : https://www.braynzarsoft.net/viewtutorial/q16390-15-high-resolution-timer
*/
...
struct Light
{
	...
	XMFLOAT3 pos;
	float range;
	XMFLOAT3 att;// attenuation factor.
	float pad2;
...
void Update(double time)
{
	...
	light.pos.x = XMVectorGetX(lightVec);
	light.pos.y = XMVectorGetY(lightVec);
	light.pos.z = XMVectorGetZ(lightVec);
